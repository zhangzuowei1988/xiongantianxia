...
@interface XAHomeViewController ()<DLCustomSlideViewDelegate,PDMITagViewDelegate>
...
- (void)viewDidLoad {
    [super viewDidLoad];
    self.navBarTitlelabel.text=@"千年大计    国家大事";
    [self initColumArray];
    [self initColumnView];
}
/**
...
-(void)initColumArray{
    ...
    NSString *jsonStr=[[NSString alloc] initWithContentsOfFile:[[NSBundle mainBundle] pathForResource:@"configure/config-home-column" ofType:@"json"] encoding:NSUTF8StringEncoding error:nil];
...
- (UIViewController *)DLCustomSlideView:(DLCustomSlideView *)sender controllerAt:(NSInteger)index{
    ...
    XAHomeListViewController *ctrl = [[XAHomeListViewController alloc] init];
