...
- (void)initialization
{
   ...
   // _pageDotColor = [CommData shareInstance].commonGrayColor;
   // _currentPageDotColor=[CommData shareInstance].skinColor;
   // _pageDotColor = [CommData shareInstance].commonGrayColor;
...
//    self.pageControl.center=CGPointMake(self.mainView.sd_width/2, self.pageControl.center.y);
