...
-(void)setAdWithVideo{
//    http://1253974410.vod2.myqcloud.com/39e66b63vodgzp1253974410/29b32ee99031868223446273547/f0.mp4
    ...
    //注意:视频广告只支持先缓存,下次显示
    videoAdconfiguration.videoNameOrURLString =@"http://1253974410.vod2.myqcloud.com/39e66b63vodgzp1253974410/29b32ee99031868223446273547/f0.mp4" ;
    //视频缩放模式
    videoAdconfiguration.scalingMode = MPMovieScalingModeNone;
    //广告点击打开链接
   // videoAdconfiguration.openURLString = nil;
    //广告显示完成动画
...
-(void)setAdWithImage{
    ...
    imageAdconfiguration.imageNameOrURLString=@"http://mp.dev.hubpd.com/xmtmedia//upload/image/2017/10/25/1508921455787.png";
    ...
    //广告点击打开链接
    // imageAdconfiguration.openURLString = nil;
    //广告显示完成动画
...
-(NSArray<UIView *> *)launchAdSubViews_alreadyView
{
    ...
    UIView *view=[[UIView alloc] initWithFrame:CGRectMake(0, [UIScreen mainScreen].bounds.size.height-200, [UIScreen mainScreen].bounds.size.width, 200)];
    view.backgroundColor=[UIColor redColor];
    
   // return [NSArray arrayWithObject:label,view];
    return [NSArray arrayWithObjects:label,view, nil];
